...
function LSTMdEoverdWi(){
    const config = {
      ...
      const Ftgeneral = '$$ {F_t = }\\sigma_s{(\\sum_{i=0}^M W_f \\otimes x_t + bias(optional))} = \\sigma_s{( W_f \\odot x_t + bias(optional))}{= \\sigma_s{(d)} \\; {,where \\; d=\\sum_{i=0}^M W_f \\otimes x_t \\; is \\; sigmoid \\; and \\; d1=\\sum_{i=0}^M d2}, \\; d2=W_f \\otimes x_t}$$'; 
      const itgeneral = '$$ {i_t = }\\sigma_s{(\\sum_{i=0}^M W_i \\otimes x_t + bias(optional))} = \\sigma_s{( W_i \\odot x_t + bias(optional))} = \\sigma_s{(d5)} \\; {where \\; d5=\\sum_{i=0}^M W_i \\otimes x_t \\; is \\; sigmoid \\; and \\; d6=\\sum_{i=0}^M d7}, \\; d7=W_i \\otimes x_t   $$';
      ...
      const Cdtgeneral = "$$ {C'_t = }\\sigma_t{(\\sum_{i=0}^M W_c \\otimes x_t + bias(optional))} = \\sigma_t{( W_c \\odot x_t + bias(optional))}{= \\sigma_t{(d10)} \\; {,where \\; d10=\\sum_{i=0}^M W_c \\otimes x_t \\; is \\; sigmoid \\; and \\; d11=\\sum_{i=0}^M d12}, \\; d12=W_c \\otimes x_t \\; where \\; \\sigma_t \\; is \\; tanh} $$";
...
const nondiagnal5 = "$$ \\frac{\\partial  (\\frac{e^{L_1}}{e^{L_1}+e^{L_2} + \\cdots + e^{L_T}})}{\\partial e^{L_2}}=\\frac{z(x)f'(x)-f(x)z'(x)}{(z(x)^2)}=\\frac{ \\sum_{i=0}^T e^{L_k} \\times 0 - e^{L_1} \\times e^{L_2}  }{(\\sum_{i=0}^T e^{L_k})^2} = 0 - \\frac{e^{L_1} \\times e^{L_2}}{\\sum_{i=0}^T e^{L_k}} =  - P_1 \\times P_2 $$"
...
const dCtoverda1 = "$$ \\frac{\\partial (a + a1)}{\\partial a1} = 1 $$" 
...
const ditoverdd = "$$\\frac{\\partial i_t}{\\partial d5_t} = \\frac{\\partial \\begin{bmatrix} sigmoid(d5_1) \\\\ sigmoid(d5_2) \\\\ \\vdots \\\\ sigmoid(d5_M) \\end{bmatrix}}{\\partial d_t} = \\begin{bmatrix} \\frac{\\partial (sigmoid(d5_1))}{\\partial d_1} & \\cancelto{0}{\\frac{\\partial (sigmoid(d5_1))}{\\partial d_2}} & \\cdots & \\cancelto{0}{\\frac{\\partial (sigmoid(d5_1))}{\\partial d_M}} \\\\ \\cancelto{0}{\\frac{\\partial (sigmoid(d5_2))}{\\partial d_1}} & \\frac{\\partial (sigmoid(d5_2))}{\\partial d_2} & \\cdots & \\cancelto{0}{\\frac{\\partial (sigmoid(d5_2))}{\\partial d_M}} \\\\ \\vdots & \\vdots & \\vdots & \\vdots \\\\ \\cancelto{0}{\\frac{\\partial (sigmoid(d5_M))}{\\partial d_1}} & \\cancelto{0}{\\frac{\\partial (sigmoid(d5_M))}{\\partial d_2}} & \\cdots & \\frac{\\partial (sigmoid(d5_M))}{\\partial d_M}  \\end{bmatrix} = sigmoid(d5_t) \\times (1 - sigmoid(d5_t)) \\ni M \\times M $$"
...
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Let us start with the first term</p>
            ...
            <p><span style={{fontSize:24.03}}><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</strong></span>Let us start with the top example&nbsp;<span style={{fontSize:24.03}}><strong>&part;(&nbsp;eᴸ&sup1; /&nbsp; (eᴸ&sup1; +&nbsp;eᴸ&sup2; + .... + eᴸᵀ) ) /&nbsp; &nbsp;&part;L₁ =&nbsp;P₁(1 - P₁)</strong></span></p>

<p><span style={{fontSize:24.03}}><strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</strong></span>since the quotient rule is:&nbsp;</p>
...
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Let us start with an diagnoal component on the resulting matrix&nbsp;<span style={{fontSize:24.03}}><strong>&part;(&nbsp;eᴸ&sup1; /&nbsp; (eᴸ&sup1; +&nbsp;eᴸ&sup2; + .... + eᴸᵀ) ) /&nbsp; &nbsp;&part;L₂ =&nbsp;P₁(1 - P₁)</strong></span></p>
            <MathJaxContext config={config} version={3}>
                <MathJax inline>
                    {applyingquotientrule1}
                    {applyingquotientrule2}
                    {applyingquotientrule3}
                    {applyingquotientrule4}
                    {applyingquotientrule5}
                    {applyingquotientrule6}
                    {applyingquotientrule7}
                </MathJax>
            </MathJaxContext>
...
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Next is the non-diagonal example&nbsp;<span style={{fontSize:24.03}}><strong>&part;(&nbsp;eᴸ&sup1; /&nbsp; (eᴸ&sup1; +&nbsp;eᴸ&sup2; + .... + eᴸᵀ) ) /&nbsp; &nbsp;&part;L₂ =&nbsp;P₁(1 - P₁)</strong></span></p>
...
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Finally we can have our output, for another derivation that based on shorten symbol, you can check out this post by <a href=".thegreenplace.net/2016/the-softmax-function-and-its-derivative/">Eli</a></p>
